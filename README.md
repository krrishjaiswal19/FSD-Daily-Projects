...
Today I learn HTML input types textarea select dropdown radio, checkbox form + submit button and make the small project using all of this.

# DAY-3 Students-Marks-Table-page-Project
Today I learn HTML Tables table, tr, th, td colspan, rowspan forms + table combine and make the small project using all of this. 
...
video tags HTML entities (©, <, >) Meta tags basics (SEO ka intro) and make the small project using all of this.  
