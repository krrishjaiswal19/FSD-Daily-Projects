...
# DAY 23 – CSS Keyframe Animations
...
## Projects
1. CSS Animated Loader
2. CSS Bouncing Ball Animation

## Learning Outcome
Understood how to create smooth animations using CSS without JavaScript.
